...
class fleximportBase
{
	...
	*/
    ...
    {
        $session = JFactory::getSession();
        $session->clear('data', 'fleximport');
        $session->clear('dataFile', 'fleximport');
        $session->clear('files', 'fleximport');
        $session->clear('finish', 'fleximport');
        $session->clear('step', 'fleximport');
        $session->clear('step0First', 'fleximport');
        $session->clear('step1First', 'fleximport');
        $session->clear('step2First', 'fleximport');
        $session->clear('step3First', 'fleximport');
        $session->clear('ParsedFile', 'fleximport');
        $session->clear('idData', 'fleximport');
        $session->clear('stepParse', 'fleximport');
        $session->clear('addError', 'fleximport');
        $session->clear('addSuccess', 'fleximport');
        $session->clear('updateError', 'fleximport');
        $session->clear('updateSuccess', 'fleximport');
        $session->clear('deleteError', 'fleximport');
        $session->clear('deleteSuccess', 'fleximport');
        $session->clear('stepImport', 'fleximport');
        $session->clear('logFileName', 'fleximport');
        $session->clear('cronTask', 'fleximport');
